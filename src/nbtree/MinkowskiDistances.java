...
public class MinkowskiDistances {
	...
	public static double fastMap ( Double[] p1 ) {
		...
		for ( int i = 0 ; i < p1.length ; i++ ) if ( i % 2 == 0 ) { 
		...
		return (jensenShannonDivergence(p1,pivot1) + jensenShannonDivergence(pivot1,pivot2) - jensenShannonDivergence(p1,pivot2)) / 
		       (2.0 * Math.sqrt(jensenShannonDivergence(pivot1,pivot2)));
	}
    ...
    public static double jensenShannonDivergence( Double[] p1, Double[] p2 ) {
      ...
      return (klDivergence(p1, average) * 0.5) + (klDivergence(p2,average) * 0.5);
    }
    
	public static double sklDivergence( Double[] p1, Double[] p2 ) {
	  return ( 0.5 * klDivergence(p1,p2) ) + ( 0.5 * klDivergence(p2,p1) );
    }
